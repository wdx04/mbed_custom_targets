...
/**
  ...
  *                                    | (external 25 MHz clock)               | (internal 8 MHz)
  *                                    | 2- PLL_HSE_XTAL / DEVICE_USBDEVICE    |
  *                                    | (external 25 MHz xtal)                |
  *-------------------------------------------------------------------------------------------
...
uint8_t SetSysClock_PLL_HSE(uint8_t bypass)
{
    ...
    RCC_PeriphCLKInit.UsbClockSelection = RCC_USBCLKSOURCE_PLL_DIV3;
    ...
    HAL_RCC_MCOConfig(RCC_MCO, RCC_MCO1SOURCE_PLL3CLK, RCC_MCODIV_1); // 50 MHz
